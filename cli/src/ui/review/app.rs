...
/// One row of the review queue, mirroring `LoadedImport.txns` by index.
#[derive(Debug)]
...
pub fn filter_accounts(accounts: &[String], input: &str) -> Vec<usize> {
...
/// `LoadedImport` the pure state machine does not own.
